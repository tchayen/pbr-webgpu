  ...
  return (
    <>
      ...
      <div className="absolute bottom-0 right-0">
        <div className="m-2 flex flex-col gap-4 rounded-md bg-slatedark3 p-4 shadow-sm">
          <div className="flex flex-col gap-1">
            <div className="text-xs text-slatedark10">Tone mapping</div>
            <Select.Root
              value={toneMapping}
          ...
          <div className="flex flex-col gap-1">
            <div className="text-xs text-slatedark10">Environment HDRI</div>
            <Select.Root
              value={environment}
